...
public:
    ...
    void GetProperty(const GetPropertyRequest request, std::shared_ptr<UserAuthCallback> callback);
    void SetProperty(const SetPropertyRequest request, std::shared_ptr<UserAuthCallback> callback);
