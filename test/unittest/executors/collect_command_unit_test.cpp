...
namespace UserIam {
namespace UserAuth {
class CollectCommandUnitTest : public testing::Test {
public:
...
void CollectCommandUnitTest::SetUpTestCase()
{
}

void CollectCommandUnitTest::TearDownTestCase()
{
}

void CollectCommandUnitTest::SetUp()
{
}

void CollectCommandUnitTest::TearDown()
{
}

HWTEST_F(CollectCommandUnitTest, CollectCommand_OnResultTest_001, TestSize.Level0)
{
    ...
    Attributes attr;
    auto command = Common::MakeShared<CollectCommand>(executor, testScheduleId, attr, messenger);
    ASSERT_NE(command, nullptr);
    command->OnResult(testResultCode, testExtraInfo);
}

HWTEST_F(CollectCommandUnitTest, CollectCommand_OnResultTest_002, TestSize.Level0)
{
    static const uint64_t testScheduleId = 123;
    static const ResultCode testResultCode = static_cast<ResultCode>(456);
    static const std::vector<uint8_t> testExtraInfo = {7, 8, 9};
...
HWTEST_F(CollectCommandUnitTest, CollectCommand_OnResultTest_003, TestSize.Level0)
{
    static const uint64_t testScheduleId = 123;
    static const ResultCode testResultCode = static_cast<ResultCode>(456);
...
HWTEST_F(CollectCommandUnitTest, CollectCommand_OnResultTest_004, TestSize.Level0)
{
    static const uint64_t testScheduleId = 123;
    static const ResultCode testResultCode = static_cast<ResultCode>(456);
...
HWTEST_F(CollectCommandUnitTest, CollectCommand_OnAcquireInfoTest_001, TestSize.Level0)
{
    static const uint64_t testScheduleId = 123;
...
HWTEST_F(CollectCommandUnitTest, CollectCommand_OnAcquireInfoTest_002, TestSize.Level0)
{
    static const uint64_t testScheduleId = 123;
    static const uint64_t testAcquire = 456;
    static const std::vector<uint8_t> testExtraInfo = {7, 8, 9};
...
HWTEST_F(CollectCommandUnitTest, CollectCommand_MixTest_001, TestSize.Level0)
{
    static const uint64_t testScheduleId = 123;
    static const uint64_t testAcquire = 456;
    static const ResultCode testResultCode = static_cast<ResultCode>(456);
...
HWTEST_F(CollectCommandUnitTest, CollectCommand_MixTest_002, TestSize.Level0)
{
    auto messenger = MakeShared<MockIExecutorMessenger>();
    ASSERT_NE(messenger, nullptr);
    auto executor = Common::MakeShared<Executor>(nullptr, nullptr, 3);
    ...
    auto command = Common::MakeShared<CollectCommand>(executor, testScheduleId, attr, nullptr);
    int destRole = 0;
