...
public:
    ...
    MOCK_METHOD2(BeginAuthenticationv4_0, bool(HdiCallerType callerType, std::vector<HdiScheduleInfo> &infos));
    MOCK_METHOD2(BeginAuthenticationV4_1, bool(HdiCallerType callerType, std::vector<HdiScheduleInfo> &infos));
    MOCK_METHOD2(Start,
