 ...
 */
#ifndef IAM_MOCK_IDENTIFICATION_H
#define IAM_MOCK_IDENTIFICATION_H
...
namespace UserIam {
namespace UserAuth {
class MockIdentification final : public Identification {
public:
    virtual ~MockIdentification() = default;
    ...
    MOCK_METHOD2(Update, bool(const std::vector<uint8_t> &scheduleResult, IdentifyResultInfo &resultInfo));
...
#endif // IAM_MOCK_IDENTIFICATION_H