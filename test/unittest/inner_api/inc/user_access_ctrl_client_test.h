...
#ifndef USER_ACCESS_CTRL_CLIENT_TEST_H
#define USER_ACCESS_CTRL_CLIENT_TEST_H
...
namespace UserIam {
namespace UserAuth {
class UserAccessCtrlClientTest : public testing::Test {
public:
...
#endif // USER_ACCESS_CTRL_CLIENT_TEST_H