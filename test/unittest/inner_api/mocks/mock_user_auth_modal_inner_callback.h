...
#ifndef MOCK_USER_AUTH_MODAL_INNER_CALLBACK_H
#define MOCK_USER_AUTH_MODAL_INNER_CALLBACK_H
...
namespace UserIam {
namespace UserAuth {
class MockUserAuthModalInnerCallback final : public UserAuthModalInnerCallback {
public:
...
#endif // MOCK_USER_AUTH_MODAL_INNER_CALLBACK_H