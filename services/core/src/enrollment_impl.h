...
private:
    ...
    bool BeginEnrollmentV4_0(int32_t userType, HdiCallerType callerType, HdiScheduleInfo &infos);
    bool BeginEnrollmentV4_1(int32_t userType, HdiCallerType callerType, HdiScheduleInfo &infos);
