...
namespace UserIam {
namespace UserAuth {
UpdatePinParamImpl::UpdatePinParamImpl(uint64_t oldCredentialId, std::vector<uint8_t> oldRootSecret,
    std::vector<uint8_t> rootSecret, std::vector<uint8_t> authToken)
