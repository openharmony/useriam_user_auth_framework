...
namespace UserAuth {
class WidgetContext;
class WidgetContextCallbackImpl : public IamCallbackInterface,
    public std::enable_shared_from_this<WidgetContextCallbackImpl>, public NoCopyable {
public:
    explicit WidgetContextCallbackImpl(WidgetContext *widgetContext, int32_t authType);
...
private:
    std::mutex mutex_;
    WidgetContext *widgetContext_ {nullptr};
