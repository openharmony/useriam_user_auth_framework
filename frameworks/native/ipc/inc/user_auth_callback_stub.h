...
public:
    explicit UserAuthCallbackStub(std::shared_ptr<AuthenticationCallback> &impl);
    explicit UserAuthCallbackStub(std::shared_ptr<IdentificationCallback> &impl);
...
public:
    explicit SetExecutorPropertyCallbackStub(std::shared_ptr<SetPropCallback> &impl);
