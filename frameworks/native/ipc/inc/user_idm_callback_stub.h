...
class IdmGetCredentialInfoCallbackStub : public IRemoteStub<IdmGetCredInfoCallbackInterface>, public NoCopyable {
public:
    explicit IdmGetCredentialInfoCallbackStub(const std::shared_ptr<GetCredentialInfoCallback> &impl);
    ~IdmGetCredentialInfoCallbackStub() override = default;
    int32_t OnRemoteRequest(uint32_t code, MessageParcel &data, MessageParcel &reply, MessageOption &option) override;
