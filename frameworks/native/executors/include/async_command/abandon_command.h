...
#ifndef ABANDON_COMMAND_H
#define ABANDON_COMMAND_H
...
namespace UserIam {
namespace UserAuth {
class AbandonCommand : public AsyncCommandBase {
public:
    AbandonCommand(std::weak_ptr<Executor> executor, uint64_t scheduleId, const Attributes &commandAttrs,
