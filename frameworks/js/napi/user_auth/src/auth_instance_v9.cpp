...
ResultCodeV9 AuthInstanceV9::GetAvailableStatus(napi_env env, napi_callback_info info)
{
...
ResultCodeV9 AuthInstanceV9::Init(napi_env env, napi_callback_info info)
{
    if (callback_ == nullptr) {
...
ResultCodeV9 AuthInstanceV9::On(napi_env env, napi_callback_info info)
{
    if (callback_ == nullptr) {
        IAM_LOGE("callback is null");
        return ResultCodeV9::GENERAL_ERROR;
...
ResultCodeV9 AuthInstanceV9::Off(napi_env env, napi_callback_info info)
{
    if (callback_ == nullptr) {
        IAM_LOGE("callback is null");
        return ResultCodeV9::GENERAL_ERROR;
...
ResultCodeV9 AuthInstanceV9::Start(napi_env env, napi_callback_info info)
{
    if (callback_ == nullptr) {
        IAM_LOGE("callback is null");
        return ResultCodeV9::GENERAL_ERROR;
...
ResultCodeV9 AuthInstanceV9::Cancel(napi_env env, napi_callback_info info)
{
    if (callback_ == nullptr) {
        IAM_LOGE("callback is null");
        return ResultCodeV9::GENERAL_ERROR;
