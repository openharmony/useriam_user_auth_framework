...
napi_value UserAuthTipCodeConstructor(napi_env env)
{
    ...
    napi_value compareFailure = nullptr;
    napi_value timeout = nullptr;
    napi_value temporaryPinInvalid = nullptr;
    napi_value permanentPinInvalid = nullptr;
    ...
    NAPI_CALL(env, napi_create_int32(env, UserAuthTipCode::TIP_CODE_TEMPORARILY_LOCKED, &temporaryPinInvalid));
    NAPI_CALL(env, napi_create_int32(env, UserAuthTipCode::TIP_CODE_PERMANENTLY_LOCKED, &permanentPinInvalid));
    ...
    NAPI_CALL(env, napi_set_named_property(env, userAuthTipCode, "TEMPORARY_PIN_INVALID", temporaryPinInvalid));
    NAPI_CALL(env, napi_set_named_property(env, userAuthTipCode, "PERMANENT_PIN_INVALID", permanentPinInvalid));
